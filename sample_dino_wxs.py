...
ckpt_path = "/ytech_m2v3_hdd/yuanziyang/sml/FVG/exps/0208-E0031_LightingDiT_XL_Flow_Dinov3_vitsp_BS256_cache_qknorm_wxs_learnable_latent_space-GPU8/checkpoints/0050000.pt"
...
mode = "euler"
new_latent_space_samples = diffusion.sample(z, y, y_null, sample_steps=num_steps, cfg=cfg_scale, mode=mode, timestep_shift=timestep_shift)[-1]

samples = diffusion.model.reversible_module.rev_forward(new_latent_space_samples)
