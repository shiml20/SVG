...
class GaussianDiffusion:
    ...
    def p_mean_variance(self, model, x, t, clip_denoised=True, denoised_fn=None, model_kwargs=None):
        ...
        if isinstance(model_output, tuple):
            ...
            # NOTE shiml20 check
            real_capacity_all_cond = model_output[-1]
    ...
    def p_sample_loop_progressive(
        ...
        # print(indices)
        for cur_sampling_step, i in enumerate(indices):
            os.environ["cur_step"] = f"{cur_sampling_step:003d}"
            # print(cur_sampling_step)
