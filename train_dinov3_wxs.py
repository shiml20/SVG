...
from rev_vit_wxs import RevViT
...
def main(config):
    ...
    model.reversible_module = RevViT(depth=24, embed_dim=192)
    ...
    if not use_latent:
        ...
        # vae = AutoencoderKL.from_pretrained(model_path).to(device=device)
        # REPO_DIR = "/ytech_m2v3_hdd/yuanziyang/sml/dinov3"
        # encoder_dict = {
            # "dinov3_vits16plus": "/ytech_m2v3_hdd/yuanziyang/sml/FVG/dinov3/dinov3_vits16plus_pretrain_lvd1689m-4057cbaa.pth",
            # "dinov3_vitb16": "/ytech_m2v3_hdd/yuanziyang/sml/FVG/dinov3/dinov3_vitb16/dinov3_vitb16_pretrain_lvd1689m-73cec8be.pth",
            # "dinov3_vith16plus": "/ytech_m2v3_hdd/yuanziyang/sml/FVG/dinov3/dinov3_vithp16/dinov3_vith16plus_pretrain_lvd1689m-7c1da9a5.pth",
        # }
        # dinov3 = torch.hub.load(
            # REPO_DIR,
            # config.basic.encoder,
            # source='local',
            # weights=encoder_dict[config.basic.encoder]
        # )

        # dinov3 = dinov3.to(device=device)
    ...
    for epoch in range(config.basic.epochs):
        ...
        for x, y in loader:
            ...
            x = diffusion.model.module.reversible_module(x)
