...
ckpt_path = "/ytech_m2v3_hdd/yuanziyang/sml/DiffMoE_research_local/exps/0000-Dense-XL/checkpoints/0200000.pt"
...
save_image(samples, f"sample_{exp_name}_{step}_sample{num_sampling_steps}_shift{timestep_shift}.png", nrow=int(samples_per_row), 
