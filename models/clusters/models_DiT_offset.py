...
class DiT(nn.Module):
    ...
    def forward(self, x, t, y):
        ...
        x_8 = self.final_layer1(x_8, c)                # (N, T, patch_size ** 2 * out_channels)
        x = self.final_layer2(x, c)                # (N, T, patch_size ** 2 * out_channels)

        x_8 = self.unpatchify(x_8)                   # (N, out_channels, H, W)
