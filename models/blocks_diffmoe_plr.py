...
class SparseMoEBlock(nn.Module):
    ...
    """
    def __init__(self, experts, hidden_dim, num_experts, n_shared_experts=0, capacity=1, mlp_ratio=4.0):
        super().__init__()
    ...
    def forward_train(self, x):
        ...
        plr_value = plr_value.reshape(B, s, -1)

        scores = logits.permute(1, 0)  # (num_experts, S)
        ...
        return x_out, ones, capacity_pred, plr_value
    ...
    def forward_eval(self, x):
        ...
        scores = logits.permute(-1, -2)     #  num_experts, bs*seq_len
