...
from .dtr_taskrouting_dC import *
...
class DiTBlock(nn.Module):
    ...
    def __init__(self, hidden_size, num_heads, head_dim=None, mlp_ratio=4.0, 
                 use_swiglu=False, MoE_config=None, use_moe=False, routing=None, 
                 **block_kwargs):
        super().__init__()
    ...
    def forward(self, x, c):
        ...
        routed_x = x * self.routing.active_mask
    ...
    def __init__(
        ...
        self.blocks = nn.ModuleList([
            DiTBlock(hidden_size, num_heads // (1 if use_moe_flag[_] else 1), head_dim=head_dim, mlp_ratio=mlp_ratio, 
                    ...
                    routing=router(hidden_size, taskcount, sharing_ratio, init_method),
