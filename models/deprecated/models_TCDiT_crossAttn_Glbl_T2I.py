...
from .blocks_base_crossAttn import *
from .blocks_tcmoe import *
...
class DiTBlock(nn.Module):
    ...
    """
    def __init__(
        self, hidden_size, num_heads, mlp_ratio=4, head_dim=None,
        ...
        **block_kwargs
        ...
        self.normca = nn.LayerNorm(hidden_size, elementwise_affine=False, eps=1e-6)
        ...
        self.cattn = CrossAttention(hidden_size, num_heads=num_heads, head_dim=head_dim, qkv_bias=True, **block_kwargs)
    ...
    def forward(self, x, c, mask=None):
        ...
        x = x + self.cattn(self.normca(x), c, mask)
        
        if self.use_moe:
            x_mlp, ones, pred_c = self.mlp(self.norm2(x))
            x = x + x_mlp
...
class DiT(nn.Module):
    ...
    def forward(self, x, t, y, mask=None):
        ...
        return x, "TC_Glbl", layer_idx_list, fi_list, Pi_list
